...
function sendForceStartClusterOperation() {
...
function triggerPartialStart(data) {
...
function sendGetClusterHotRestartStatusOperation() {
     var data = {
...
function getClusterHotRestartStatus(data) {
    var clusterNameContainer = $("#clusterNameContainer");
    ...
    var clusterHRStatusContainer = $("#clusterHRStatusContainer");
    var dataRecoveryPolicyContainer = $("#dataRecoveryPolicyContainer");
    var remainingDataLoadTimeContainer = $("#remainingDataLoadTimeContainer");
    var remainingValidationTimeContainer = $("#remainingValidationTimeContainer");
...
function getMemberHotRestartStatus(data) {
...
function sendGetClusterHRBackupStatusOperation() {
     var data = {
            operation: 'getClusterHRBackupStatus',
            cluster: activeCluster
     }
     opcall(data)
     sendGetHotBackupEnabledOperation();
}

function sendGetHotBackupEnabledOperation() {
    var data = {
...
function getHotBackupEnabled(data) {
    if(data) {
...
function getClusterHRBackupStatus(data) {
