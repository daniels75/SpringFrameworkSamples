...
if %argC% == 4 (
    ...
    java -cp "hazelcast-mancenter-3.12.8.war;%3" Launcher %1 %2
)
...
if %argC% == 2 (
    java -cp hazelcast-mancenter-3.12.8.war Launcher %1 %2
)

if %argC% == 0 (
    java -cp hazelcast-mancenter-3.12.8.war Launcher
)
